...
//
/*explicit*/ IoRingPageFileDevice::IoRingPageFileDevice(
    page_device_id_int device_id, IoRing::File* file,
                                 ...
                                 WriteHandler&& handler)
{
  ...
  PageDeviceMetrics::instance()
      .write_count_per_page_size_log2[batt::log2_ceil(this->page_size())]
      .add(1);
...
void IoRingPageFileDevice::read(PageId page_id, ReadHandler&& handler)
{
  ...
  PageDeviceMetrics::instance()
      .read_count_per_page_size_log2[batt::log2_ceil(this->page_size())]
      .add(1);
