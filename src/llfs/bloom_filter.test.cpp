...
{
  for (u8 layout : {PackedBloomFilter::kLayoutFlat, PackedBloomFilter::kLayoutBlocked64,
                    PackedBloomFilter::kLayoutBlocked512}) {
    LLFS_LOG_INFO() << BATT_INSPECT((int)layout) << std::endl;
